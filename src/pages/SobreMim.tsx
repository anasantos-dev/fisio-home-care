          ...
          <div className={styles.heroCard}>
            <div className={styles.heroTextBox}>
              ...
              <h1 className={styles.heroTitle}>
                <span className={styles.heroTitleGreen}>Sobre mim<br /></span>
                <span className={styles.heroTitleGold}>Fisioterapia humanizada é minha prioridade</span>
              </h1>
              
              <p className={styles.heroDesc}>
                Olá! Eu sou o <b>Dr. Israel Cascaes</b>, fisioterapeuta comprometido em promover saúde, autonomia e qualidade de vida em todas as fases da vida. Minha prática é guiada pelo respeito às particularidades de cada paciente, oferecendo um atendimento próximo, acolhedor e baseado em escuta atenta.<br /><br />
               Ao longo da minha trajetória, dediquei atenção especial ao cuidado com idosos, auxiliando na prevenção de limitações, na recuperação de movimentos e na valorização da independência. Acredito que a fisioterapia vai além do tratamento: é uma oportunidade de transformar vidas, devolver confiança e proporcionar resultados reais na sua saúde!
              </p>
